 ...
 *
 * В этом стенде он нужен ровно в двух местах: длительность фаз cpu и выбор
 * готового case в select — тот самый «псевдослучайный» выбор из спецификации Go.
 */
export class Rng {
  private s: number
  ...
  /** Равновероятный выбор одного из готовых вариантов — как в selectgo. */
  pick<T>(items: T[]): T {
